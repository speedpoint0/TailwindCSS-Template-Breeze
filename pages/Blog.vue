<template>
  <div class="overflow-hidden">
        ...
        <div class="mx-auto grid max-w-xl gap-4">
          ...
          >
            ...
            <div class="pt-4 sm:px-8 sm:pt-0">
              ...
              <p class="text-sm">November 12, 2022</p>
            </div>
          </div>
          <!-- Blog Item -->
          <div
    ...
    <section>
      ...
      >
        ...
        <div class="grid items-center gap-8 sm:gap-20 lg:grid-cols-2">
          ...
          <div class="mx-auto max-w-xl bg-[#f2f2f7] p-8 text-center">
            <!-- Contact Form Title -->
            ...
            >
              <div class="mb-4 flex flex-col gap-y-2">
                ...
                <input
                  type="text"
                  class="h-9 w-full bg-white px-3 py-6 text-sm text-[#333333]"
                  placeholder=""
                  required=""
                />
              </div>
              ...
              <div class="mb-8 flex flex-col gap-y-2">
                ...
                <textarea
                  placeholder=""
                  class="h-auto min-h-[186px] w-full overflow-auto bg-white px-3 py-2 text-sm text-[#333333]"
                >
                </textarea>
              </div>
              <input
                ...
                class="inline-block w-full cursor-pointer bg-[#276ef1] px-6 py-4 text-center font-semibold text-white transition [box-shadow:rgb(171,_196,_245)_-8px_8px] hover:[box-shadow:rgb(171,_196,_245)_0px_0px]"
              />
            </form>
          </div>
        </div>
    ...
    <section>
      <div
        class="w-screen flex-col bg-black px-6 py-20 text-white lg:flex lg:px-10 xl:px-24"
      >
        <!-- TOP CONTAINER -->
        <div class="lg:flex lg:flex-row lg:justify-between">
          ...
          <div>
            ...
            <a href="#" class="inline-block max-w-full">
              <img
                src="https://assets.website-files.com/6357722e2a5f19121d37f84d/6358f89d8088ab28fa7e8f5c_Group%2047874-3.svg"
                alt=""
          ...
          >
            <!-- LINK BLOCK -->
            <div
              class="mb-5 mr-8 flex max-w-[200px] grow basis-[100px] flex-col space-y-5 lg:mx-10"
            >
          ...
          <div class="flex flex-col">
            ...
            <div class="mb-4 flex flex-row items-center">
              <img
                ...
                class="mr-3 inline-block"
              />
              <p class="font-inter ml-4">support@devjoy.xyz</p>
            </div>
          </div>
        </div>
        <!-- DIVIDER -->
        ...
        <!-- COPYRIGHT TEXT -->
        <div>
          <p class="font-inter lg: text-center text-sm text-gray-500">
