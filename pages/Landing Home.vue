<template>
	<div class="overflow-hidden">
		...
		<section class="bg-black text-white">
			...
			<div class="mx-auto w-full max-w-7xl px-5 py-16 md:px-10 md:py-24">
				<!-- Title -->
				<h2 class="mb-8 text-center text-3xl font-bold md:mb-14 md:text-5xl">
		...
		<section>
			...
			<div class="mx-auto w-full max-w-7xl px-5 py-16 md:px-10 md:py-24">
				<!-- Pricing Title -->
				<h2 class="text-center text-3xl font-bold md:text-5xl">Get Started</h2>
				<p
		...
		<section>
			...
			<div class="mx-auto w-full max-w-7xl px-5 py-16 md:px-10 md:py-24">
				...
				<!-- FAQ Content -->
				<div class="mb-12 flex flex-wrap justify-center gap-4 lg:grid-cols-2">
					<!-- FAQ Item -->
					<div
